        ...
        <div class="wrap-login100">
          ...
          <form class="login100-form validate-form layui-form">
            ...
            <div class="wrap-input100 validate-input">
              <div class="layui-form-item">
                <div class="layui-input-block" style="margin-left: 0;">
                  <input class="input100" type="text" id="huodongbiaoti" name="huodongbiaoti" placeholder="请输入活动标题" autocomplete="off" class="layui-input" lay-ignore>
                </div>
              </div>
            ...
            <div class="wrap-input100 validate-input">
              <div class="layui-form-item">
                <div class="layui-input-block" style="margin-left: 0;">
                  <input class="input100" type="text" id="huodongdidian" name="huodongdidian" placeholder="请输入活动地点" autocomplete="off" class="layui-input" lay-ignore>
                </div>
              </div>
              <span class="focus-input100"></span>
              <span class="symbol-input100">
            ...
            <div class="wrap-input100 validate-input">
              <div class="layui-form-item">
                <div class="layui-input-block" style="margin-left: 0;">
                  <input class="input100" type="text" id="kaishishijian" name="kaishishijian" placeholder="请输入开始时间" autocomplete="off" class="layui-input" lay-ignore>
                </div>
              </div>
              <span class="focus-input100"></span>
              <span class="symbol-input100">
            ...
            <div class="wrap-input100 validate-input">
              <div class="layui-form-item">
                <div class="layui-input-block" style="margin-left: 0;">
                  <input class="input100" type="text" id="jieshushijian" name="jieshushijian" placeholder="请输入结束时间" autocomplete="off" class="layui-input" lay-ignore>
                </div>
              </div>
              <span class="focus-input100"></span>
              <span class="symbol-input100">
